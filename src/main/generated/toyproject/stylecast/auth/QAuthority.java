...
public class QAuthority extends EntityPathBase<Authority> {
    ...
    private static final long serialVersionUID = -1588393426L;
    ...
    public final toyproject.stylecast.domain.QMember member;
    ...
    public QAuthority(Class<? extends Authority> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new toyproject.stylecast.domain.QMember(forProperty("member"), inits.get("member")) : null;
    }
